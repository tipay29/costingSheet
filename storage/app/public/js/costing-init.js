    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            fabric_row_tds_add = fabric_row_tds_add.concat('' +
                ...
                '<input type="text" id="costing_fabric_size_'+i+'_'+fabric_row+'" name="costing_fabric_size_'+i+'_'+fabric_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            fabric_row_tds_add = fabric_row_tds_add.concat('' +
                ...
                '<input type="text" id="costing_fabric_color_'+i+'_'+fabric_row+'" name="costing_fabric_color_'+i+'_'+fabric_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
...
costing_add_trim_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            trim_row_tds_add = trim_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_trim_size_'+i+'_'+trim_row+'" name="costing_trim_size_'+i+'_'+trim_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            trim_row_tds_add = trim_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_trim_color_'+i+'_'+trim_row+'" name="costing_trim_color_'+i+'_'+trim_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
...
costing_add_zipper_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            zipper_row_tds_add = zipper_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_zipper_size_'+i+'_'+zipper_row+'" name="costing_zipper_size_'+i+'_'+zipper_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            zipper_row_tds_add = zipper_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_zipper_color_'+i+'_'+zipper_row+'" name="costing_zipper_color_'+i+'_'+zipper_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let zipper_row_tds = '' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_zipper_material_id'+zipper_row+'" name="costing_zipper_material_id'+zipper_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_zipper_categories'+zipper_row+'" name="costing_zipper_categories'+zipper_row+'" value="Zipper" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
...
costing_add_embelishment_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            embelishment_row_tds_add = embelishment_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_embelishment_size_'+i+'_'+embelishment_row+'" name="costing_embelishment_size_'+i+'_'+embelishment_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            embelishment_row_tds_add = embelishment_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_embelishment_color_'+i+'_'+embelishment_row+'" name="costing_embelishment_color_'+i+'_'+embelishment_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let embelishment_row_tds = ' ' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_embelishment_material_id'+embelishment_row+'" name="costing_embelishment_material_id'+embelishment_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <select class="css-select-costing-table" id="costing_embelishment_categories'+embelishment_row+'" name="costing_embelishment_categories'+embelishment_row+'" style="text-align: start;">' +
...
costing_add_label_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            label_row_tds_add = label_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_label_size_'+i+'_'+label_row+'" name="costing_label_size_'+i+'_'+label_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            label_row_tds_add = label_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_label_color_'+i+'_'+label_row+'" name="costing_label_color_'+i+'_'+label_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let label_row_tds = '' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_label_material_id'+label_row+'" name="costing_label_material_id'+label_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_label_categories'+label_row+'" name="costing_label_categories'+label_row+'" value="" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
...
costing_add_thread_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            thread_row_tds_add = thread_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_thread_size_'+i+'_'+thread_row+'" name="costing_thread_size_'+i+'_'+thread_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            thread_row_tds_add = thread_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_thread_color_'+i+'_'+thread_row+'" name="costing_thread_color_'+i+'_'+thread_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
...
costing_add_package_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            package_row_tds_add = package_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_package_size_'+i+'_'+package_row+'" name="costing_package_size_'+i+'_'+package_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            package_row_tds_add = package_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_package_color_'+i+'_'+package_row+'" name="costing_package_color_'+i+'_'+package_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
...
costing_add_finish_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            finish_row_tds_add = finish_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_finish_size_'+i+'_'+finish_row+'" name="costing_finish_size_'+i+'_'+finish_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            finish_row_tds_add = finish_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_finish_color_'+i+'_'+finish_row+'" name="costing_finish_color_'+i+'_'+finish_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let finish_row_tds = ' ' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_finish_material_id'+finish_row+'" name="costing_finish_material_id'+finish_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_finish_categories'+finish_row+'" name="costing_finish_categories'+finish_row+'" value="" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
...
costing_add_export_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            export_row_tds_add = export_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_export_size_'+i+'_'+export_row+'" name="costing_export_size_'+i+'_'+export_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            export_row_tds_add = export_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_export_color_'+i+'_'+export_row+'" name="costing_export_color_'+i+'_'+export_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let export_row_tds = '' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_export_material_id'+export_row+'" name="costing_export_material_id'+export_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_export_categories'+export_row+'" name="costing_export_categories'+export_row+'" value="" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
...
costing_add_testing_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            testing_row_tds_add = testing_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_testing_size_'+i+'_'+testing_row+'" name="costing_testing_size_'+i+'_'+testing_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            testing_row_tds_add = testing_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_testing_color_'+i+'_'+testing_row+'" name="costing_testing_color_'+i+'_'+testing_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let testing_row_tds = ' ' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text"  id="costing_testing_material_id'+testing_row+'" name="costing_testing_material_id'+testing_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_testing_categories'+testing_row+'" name="costing_testing_categories'+testing_row+'" value="Testing #'+(parseInt(testing_row)+1)+'" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
...
costing_add_other_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            other_row_tds_add = other_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_other_size_'+i+'_'+other_row+'" name="costing_other_size_'+i+'_'+other_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            other_row_tds_add = other_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_other_color_'+i+'_'+other_row+'" name="costing_other_color_'+i+'_'+other_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let other_row_tds = ' ' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_other_material_id'+other_row+'" name="costing_other_material_id'+other_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_other_categories'+other_row+'" name="costing_other_categories'+other_row+'" value="" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
...
costing_add_labor_row_btn.click(function(e){
    ...
    if(no_of_size !== 0){
        for (let i = 1; i <= no_of_size; i++) {
            labor_row_tds_add = labor_row_tds_add.concat('' +
                '<td class="costing_table_size">' +
                '<input type="text" id="costing_labor_size_'+i+'_'+labor_row+'" name="costing_labor_size_'+i+'_'+labor_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    if(no_of_color !== 0){
        for (let i = 1; i <= no_of_color; i++) {
            labor_row_tds_add = labor_row_tds_add.concat('' +
                '<td class="costing_table_color">' +
                '<input type="text" id="costing_labor_color_'+i+'_'+labor_row+'" name="costing_labor_color_'+i+'_'+labor_row+'" value="" class=" css-input-costing-data-solo">' +
                '</td>'+
                '');
        }
    }
    ...
    let labor_row_tds = '  ' +
        ...
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_labor_material_id'+labor_row+'" name="costing_labor_material_id'+labor_row+'" value="" class="css-input-costing-data-solo" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
        '                                    <input type="text" id="costing_labor_categories'+labor_row+'" name="costing_labor_categories'+labor_row+'" value="" class="css-input-costing-data-solo" style="text-align: start;" >\n' +
        '                                     </td>' +
        '                                    <td>\n' +
