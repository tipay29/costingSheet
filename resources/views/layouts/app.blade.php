...
<head>
    ...
    @if(str_contains(url()->current(), 'costing-sheets') || str_contains(url()->current(), 'upload'))
        <script src="{{ asset('storage/js/dropzone.js') }}" defer></script>
    @endif
    ...
    @if(str_contains(url()->current(), 'costing-sheets') || str_contains(url()->current(), 'edit'))
    ...
    <link href="{{ asset('storage/css/dropzone.css') }}" rel="stylesheet">
</head>
<body >
    <div id="app">
