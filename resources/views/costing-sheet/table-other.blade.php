                    ...
                    <tr class="costing_fabric_header">
                        ...
                        <th scope="col" style="vertical-align: top;background-color: #7b9ddb;text-align:start; ">11.Others</th>
                    ...
                    <tr class="costing_fabric_header_total">
                        ...
                        <th style="background-color: #b5f7bd; ">
                            ...
                            <input type="text" id="costing_other_total_fob" value="0.00" class="css-input-costing-total" style="width: 68px;" disabled>
                        </th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th  scope="col" style="min-width:35px;border:1px solid var(--bs-body-bg);"></th>
                    </tr>
