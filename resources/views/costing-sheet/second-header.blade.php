<div class="row">
    ...
    <div class="col-md-5 css-costing-header-left">
        <table class="table table-bordered">
            ...
            <tr>
                <td class="css-text-right">MANUFACTURER 1 :</td>
                <td>
                    <select class="css-select-costing" name="costing_manufacturer_one" id="costing_manufacturer_one">
                        <option value="Invalid Vendor" disabled selected>Select Manufacturer</option>
                        <option value="Horizon Outdoor (Cambodia) Co., Ltd" >Horizon Outdoor (Cambodia) Co., Ltd</option>
                        <option value="Vicmark Fashions (Cambodia) Co., Ltd." >Vicmark Fashions (Cambodia) Co., Ltd.</option>
                        <option value="HZ Int'l Co., Ltd." >HZ Int'l Co., Ltd.</option>
                        <option value="HZ Outdoor Int’l Co., Ltd" >HZ Outdoor Int’l Co., Ltd </option>
            ...
            <tr>
                <td class="css-text-right">MANUFACTURER 2 :</td>
                <td>
