                    ...
                    <tr class="costing_header_total">
                        ...
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="text-align:start;vertical-align: top;background-color: #b5f7bd; ">2.Trims</th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        ...
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="text-align:start;vertical-align: top;background-color: #b5f7bd; " colspan="4">2. Total Cost - Trims</th>
                        <th style="background-color: #b5f7bd; "></th>
                        ...
                        <th style="background-color: #b5f7bd; ">
                            ...
                            <input type="text" id="costing_trim_total_fob" value="0.00" class="css-input-costing-total" style="width: 68px;" disabled>
                        </th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th  scope="col" style="min-width:35px;border:1px solid var(--bs-body-bg);"></th>
                    </tr>
