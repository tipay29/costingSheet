                    ...
                    <tr class="costing_header">
                        ...
                        <th scope="col" style="vertical-align: top;background-color: #7b9ddb;text-align:start; ">4.Embelishments</th>
                    ...
                    <tr class="costing_header_total">
                        ...
                        <th style="background-color: #b5f7bd; ">
                            <span style="display: none;" id="costing_embelishment_supplier_ref_btn_apply_up" class="btn_apply">&#9650</span>
                            <span style="display: none;" id="costing_embelishment_supplier_ref_btn_apply_down" class="btn_apply">&#9660</span>
                        </th>
                        <th style="background-color: #b5f7bd; ">
