                    ...
                    <tr class="costing_header_total">
                        ...
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="vertical-align: top;background-color: #b5f7bd;text-align:start; ">9.Export/Import</th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        ...
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="background-color: #b5f7bd; "></th>
                        <th style="text-align:start;vertical-align: top;background-color: #b5f7bd; " colspan="4">9. Total Cost - Export/Import</th>
                        <th style="background-color: #b5f7bd; "></th>
